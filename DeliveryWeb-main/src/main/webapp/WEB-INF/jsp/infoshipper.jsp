<%-- 
    Document   : infoshipper
    Created on : Sep 2, 2022, 10:46:21 AM
    Author     : DELL
--%>
        ...
        <div class="col-md-4">
            <div class="card card-user">
                <div class="card-body">
                    <div class="author">
                        <a href="#">
                            <img class="avatar border-gray" src="https://res.cloudinary.com/lenvo1202/image/upload/v1661905096/w7destutdjoadseneyra.png" alt="...">
                            <h5 class="title"></h5>
                        </a>
                        <p class="description">
                            ...
